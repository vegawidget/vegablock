...
- If you have **[nodejs](https://nodejs.org/en/)** installed on your system and the [**magick**](https://github.com/ropensci/magick#readme) package installed, you can include preview and thumb images with the block.
