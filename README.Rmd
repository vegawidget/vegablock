...
If want to include preview and thumb images with the block, you will need these packages:

- [**magick**](https://github.com/ropensci/magick#readme)
- [**webdriver**](https://github.com/rstudio/webdriver#README), with PhantomJS installed
