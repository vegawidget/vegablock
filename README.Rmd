...
If want to include preview and thumb images with the block, you will need **[nodejs](https://nodejs.org/en/)** installed on your system and the [**magick**](https://github.com/ropensci/magick#readme) package.
